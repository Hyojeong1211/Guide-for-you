...
public class MainContentController {
	...
	public String tourInsert(TourBasicVo param, MultipartFile[] files, HttpSession session) {
		...
		System.out.println("Afaeeaf");
		
		//파일 저장 로직 시작....
		ArrayList<UploadFileVo> fileList = new ArrayList<UploadFileVo>();
		ArrayList<String> linkList = new ArrayList<String>();
				
		String uploadFilePath = "C:\\tomcat\\apache-tomcat-8.5.43\\webapps\\GuideForYou\\uploadFiles\\";
	...
	public String tourGuideContentPage(TourBasicVo param, Model model) {
	...
	public String tourContentUpdateAction(TourBasicVo param) {
		//게시물수정
