...
public interface MemberSQLMapper {
	...
	@Update("UPDATE GF_MEMBER SET MEMBER_NICK=#{member_nick},MEMBER_PHONE=#{member_phone},MEMBER_ADDRESS=#{member_address},MEMBER_KAKAO=#{member_kakao},MEMBER_EMAIL=#{member_email} WHERE MEMBER_IDX=#{member_idx}")
	...
	@Update ("UPDATE GF_MEMBER SET MEMBER_PW=#{member_pw} WHERE MEMBER_EMAIL={member_email}")
	public void passwordMaking(MemberBasicVo vo); 
