    ...
    <body>
                	...
                	<div class="header_wrapper">
                    	...
                    	<div class="header_column2">
                        	...
                        	<a href="./logoutAction" class="headerWhenLogin headerWhenLogin_second notLogin-blackLine_second">
                            	<div class="header-row blackText">Log out</div>
                        	</a>
        ...
        <div class="container myPage_wrapper">
            ...
            <main class="guideReservationList_main">
                <div class="guideReservationList_main_title">Give review to Guide</div>
                <div class="guideWritereview_main_title ">Tour Guide</div>
                ...
                <section id="guidelList_notcomp" class=" guideReservationList_notcomp board_tabcontent">
                  <c:forEach items="${customerGuideInfoTourListForWriteReview }" var="memberTourInfo">
                    <div class="writeReview_column task ">
                        ...
                        <div class="writeReview_column_div"></div>
                        <a href="./customerEvaluationWritePage?tour_idx=${memberTourInfo.tourBasicVo.tour_idx}" class="n_guide_arrow ">Give review to Guide<i class="fas fa-chevron-right "></i></a>
                    </div>
                  </c:forEach>
