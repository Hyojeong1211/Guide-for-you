...
<script>
	...
	function go_submit() {
		...
		if (checkedNick == false) {
			alert("Please do duplicate Nickname check");
			return;
		} 
		...
		if(document.getElementById("phone_kakao").value == ""){
			alert("Pleease enter the Contect");
			return;
		}
	...
	function confirmId_JQuery() {
		console.log("ID duplicate check is running.......");
...
<script>
	function confirmNick_JQuery() {
		console.log("Nickname duplicate check is running........");
...
<body>
	...
	<form id="frm1" class="joinMemberForm" action="./joinMemberAction"
		...
		<div class="joinMemberForm_column">
			...
			placeholder="Special Does not allowed"
		...
		<div class="joinMemberForm_column">
			...
			<input type="text" class="joinMemberForm-input"
				placeholder="Special characters are not available" name="member_nick" id="member_nick_check"
				required>
		...
		<div class="joinMemberForm_column">
			...
			<input type="text" class="joinMemberForm-input" name="member_kakao" id="phone_kakao" required>
			<div class="joinMemberForm-empty"></div>
		</div>
